 ...
 *
 * libuv delegate the request making to the underline OS.  OS actually that does
 * real HTTP request; `libuv` is use to issue the request then wait some OS to
 * emit a signal some response has comeback to the request.
 *
 ...
 * making request.
 *
 * Because OS is making a request, there's no blocking of JavaScript code
